...
public interface DosyaIslemleri {
    ...
    void sortedMapEkle(String mapeEklenecekSehir, String mapeEklenecekSube, String mapeEklenecekUsta); // LinkedHashMape gelen parametreyle LinkedHashMap oluşturan metot.
}
